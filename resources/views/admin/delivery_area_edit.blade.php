                        ...
                        <form action="{{ route('admin.delivery-area.update', $area->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="name" class="form-control"  name="area_name" value="{{ $area->area_name }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>{{__('admin.Minimum delivery time')}} ({{__('admin.Minutes')}}) <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control"  name="min_time" value="{{ $area->min_time }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>{{__('admin.Maximum delivery time')}} ({{__('admin.Minutes')}}) <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control"  name="max_time" value="{{ $area->max_time }}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="status" class="form-control">
                                        <option {{ $area->status == 1 ? 'selected' : '' }} value="1">{{__('admin.Active')}}</option>
                                        <option {{ $area->status == 0 ? 'selected' : '' }} value="0">{{__('admin.Inactive')}}</option>
                                    </select>
                                </div>

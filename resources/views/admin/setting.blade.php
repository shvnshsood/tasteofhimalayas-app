                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                            ...
                                            <div class="tab-pane fade" id="colorTab" role="tabpanel" aria-labelledby="color-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-theme-color') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Primary Color')}}</label>

                                                                <input type="text" id="hue-demo" class="form-control demo" data-control="hue" name="colorPrimary" value="{{ $setting->colorPrimary }}"">

                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background one')}}</label>
                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantBg1" value="{{ $setting->gradiantBg1 }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background two')}}</label>

                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantBg2" value="{{ $setting->gradiantBg2 }}">

                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background three')}}</label>
                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantBg3" value="{{ $setting->gradiantBg3 }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background one hover')}}</label>
                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantHoverBg1" value="{{ $setting->gradiantHoverBg1 }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background two hover')}}</label>

                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantHoverBg2" value="{{ $setting->gradiantHoverBg2 }}">

                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Gradiant Background three hover')}}</label>
                                                                <input type="text" id="rgb" class="form-control minicolor demo" data-format="rgb" name="gradiantHoverBg3" value="{{ $setting->gradiantHoverBg3 }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Topbar social icon color')}}</label>

                                                                <input type="text" class="form-control demo" data-control="hue" name="topbar_social_icon_color" value="{{ $setting->topbar_social_icon_color }}"">

                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Footer color')}}</label>

                                                                <input type="text" class="form-control demo" data-control="hue" name="footer_color" value="{{ $setting->footer_color }}"">
